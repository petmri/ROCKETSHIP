...
elseif strcmp(model, 'patlak')
    ...
    if ~USE_GPU
        ...
        % Execute GPU fit
        [parameters, states, chi_squares, n_iterations, time] = gpufit_constrained(Ct_single,weights,model_id,init_param_single,constraints_single, constraint_type, tolerance, max_n_iterations,[],estimator_id,indie_vars);
