...
% existing test fixture at test_data/BIDS_test:
...
p = inputParser;
addParameter(p, 'sourceRoot', fullfile(repoRoot, 'test_data', 'BIDS_test'), @ischar);
addParameter(p, 'outputRoot', fullfile(repoRoot, 'test_data', 'synthetic', 'generated'), @ischar);
