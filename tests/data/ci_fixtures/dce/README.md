...
- `bbb_p19_downsample_x3y3`
  - Source: nearest-neighbor downsample of `tests/data/BBB data p19`
...
- `tiny_settings_case`
  - Source: synthetic tiny fixture generated by `tests/data/scripts/generate_tiny_dce_settings_fixture.py`
  - Purpose: very fast settings/feature sweeps in Python tests
  - Contains:
    - `Dynamic_t1w.nii`
    - `processed/T1_AIF_roi.nii`
    - `processed/T1_brain_roi.nii`
    - `processed/T1_map_t1_fa_fit_fa10.nii`
    - `processed/T1_noise_roi.nii`
    - `processed/tiny_fixture_meta.json`

## Regeneration notes

- Rebuild `downsample_x2` source using MATLAB synthetic generator:
  - `generate_synthetic_datasets('outputRoot','tests/data/synthetic/generated','clean',true);`
